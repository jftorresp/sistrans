...
class SQLBodega 
{
	...
	/**
	 * Crea y ejecuta la sentencia SQL para encontrar la información de LOS BODEGAES de la 
	...
	/**
	 * Crea y ejecuta la sentencia SQL para aumentar en diez el número de existencias de las bodegas de la 
	 * base de datos de SuperAndes
	 * @param pm - El manejador de persistencia
