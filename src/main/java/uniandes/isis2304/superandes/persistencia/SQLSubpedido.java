...
/**
 * Clase que encapsula los métodos que hacen acceso a la base de datos para el concepto SUBPEDIDO de SuperAndes
...
class SQLSubpedido {
	 ...
	 */
	public SQLSubpedido(PersistenciaSuperAndes pp) {
		this.pp = pp;
	}
