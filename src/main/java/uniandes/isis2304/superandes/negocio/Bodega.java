...
public class Bodega implements VOBodega{
	 ...
	 *****************************************************************/
	/**
	 * El identificador ÚNICO de las bodegas
	 */
	private long id;

	/**
	 * La capacidad en términos de volumen (metros cúbicos) que posee la bodega 
	 */
	
	private double capacidadVolumen;
	
	/**
	 * La capacidad en términos de peso (toneladas) que posee la bodega 
	 */
	 ...
	 * @param pSu - El código de la sucursal a la que pertenece la bodega.
	 */
