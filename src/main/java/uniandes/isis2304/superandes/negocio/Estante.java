...
public class Estante implements VOEstante{
	 ...
	 *****************************************************************/
	/**
	 * El identificador ÚNICO de las Estantes
	 */
	private long id;

	/**
	 * La capacidad en términos de volumen (metros cúbicos) que posee la Estante 
	 */
	
	private double capacidadVolumen;
	
	/**
	 * La capacidad en términos de peso (toneladas) que posee la Estante 
	 */
	...
	/**
	 * El código del producto que almacena
	 */
	private long producto;
	
	/**
	 * El código de la sucursal a la que pertenece
	 */
	private long sucursal;
	
	/**
	 * Nivel mínimo de unidades que deben haber, en caso contrario, se debe pedir reabastecimiento a la bodega.
	 */
	 ...
	 * @param pPro - El código del producto que se almacena
	 * @param pSu - El código de la sucursal a la que pertenece la Estante.
